...
void license::print_all_licenses() noexcept {
    ...
    Tanja84dk::license::print_title_for_licenses("argparse 3.2");
    fmt::print("{}\n\n", Tanja84dk::license::get_argparse_license());
...
const std::string license::get_argparse_license() noexcept {
    std::string license = argparse_LICENSE;
    Tanja84dk::dns_gen_private::replace_all(license, ";", "\n");
    return license;
}
